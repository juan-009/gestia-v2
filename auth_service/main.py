...
# Import middlewares
from app.interfaces.api.middlewares.error_handler import global_exception_handler_middleware
from app.interfaces.api.middlewares.auth import JWTAuthMiddleware
